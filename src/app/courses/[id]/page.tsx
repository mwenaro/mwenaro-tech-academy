...
import { BookOpen, Clock, Users, Star, Lock, CheckCircle, ChevronDown } from 'lucide-react'
...
export default async function CourseDetailPage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-light-gray to-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-deep-blue to-bright-teal text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-lg text-white text-opacity-90 mb-6">{course.description}</p>
            ...
            {course.instructor && (
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-bright-teal to-deep-blue rounded-full" />
                  <div>
                    <p className="font-medium text-dark-charcoal">{course.instructor.full_name}</p>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="font-medium text-dark-charcoal">{course.level || 'Not specified'}</p>
                </div>
                <div>
                  <p className="text-gray-600">Duration</p>
                  <p className="font-medium text-dark-charcoal">{course.duration ? `${course.duration} weeks` : 'Self-paced'}</p>
                </div>
                <div>
                  <p className="text-gray-600">Students</p>
                  <p className="font-medium text-dark-charcoal">{course.students_count || 0}</p>
                </div>
                <div>
